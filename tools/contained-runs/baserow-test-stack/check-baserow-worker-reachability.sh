...
out=$(podman run --rm --network contained-runs-baserow docker.io/library/alpine:3.20 /bin/sh -lc 'wget --header="Host: 127.0.0.1:18080" -S -T 20 -O /dev/null http://baserow:80/api/workspaces/ 2>&1 || true')
